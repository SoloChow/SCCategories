...
@implementation NSDictionary (SCPropertyList)
...
+ (NSDictionary *)sc_dictionaryWithPlistString:(NSString *)plist {
    ...
    return [self sc_dictionaryWithPlistData:data];
}
...
@implementation NSMutableDictionary (SCPropertyList)
